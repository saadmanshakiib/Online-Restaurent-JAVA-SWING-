...
public class Breakfast extends JFrame implements ActionListener, MouseListener {
    Breakfast(){
        ...
        ImageIcon b1 = new ImageIcon("src\\HomePage\\b1.png");
        JLabel p1 = new JLabel(b1);
        p1.setBounds(25,0,250,250);
        panel1.add(p1);

        JLabel B1 = new JLabel("Special BreakFast");
        ...
        order1.addActionListener(e->{
            selection s1 = new selection(320);
            s1.setVisible(true);
            setVisible(false);
        });
        ...
        ImageIcon b2 = new ImageIcon("src\\HomePage\\b2.png");
        JLabel p2 = new JLabel(b2);
        p2.setBounds(25,0,250,250);
        panel2.add(p2);
        JLabel B2 = new JLabel("Eggy BreakFast");
        B2.setBounds(50,250,200,40);
        B2.setFont(minifont);
        ...
        order2.addActionListener(e->{
            selection s1 = new selection(280);
            s1.setVisible(true);
            setVisible(false);
        });
        ...
        ImageIcon b3 = new ImageIcon("src\\HomePage\\b3.png");
        JLabel p3 = new JLabel(b3);
        p3.setBounds(25,0,250,250);
        panel3.add(p3);
        JLabel B3 = new JLabel("Bready Breakfast");
        B3.setBounds(50,250,200,40);
        B3.setFont(minifont);
        B3.setForeground(Color.ORANGE);
        panel3.add(B3);

        JLabel r3 = new JLabel("4.1 / 5.00");
        ...
        order3.addActionListener(e->{
            selection s1 = new selection(300);
            s1.setVisible(true);
            setVisible(false);
        });
...
///////////////panel 4
        ...
        ImageIcon b4 = new ImageIcon("src\\HomePage\\b4.png");
        JLabel p4 = new JLabel(b4);
        p4.setBounds(25,0,250,250);
        panel4.add(p4);
        JLabel B4 = new JLabel("Boiled Egg");
        ...
        JLabel r4 = new JLabel("4.00 / 5.00");
        ...
        order4.addActionListener(e->{
            selection s1 = new selection(250);
            s1.setVisible(true);
            setVisible(false);
        });
        //////////panel5
        ...
        ImageIcon b5 = new ImageIcon("src\\HomePage\\b5.png");
        JLabel p5 = new JLabel(b5);
        p5.setBounds(25,0,250,250);
        panel5.add(p5);
        JLabel B5 = new JLabel("Salad With Egg");
        ...
        order5.addActionListener(e->{
            selection s1 = new selection(290);
            s1.setVisible(true);
            setVisible(false);
        });
...
/////////////////////////
    ...
    public static void main(String[] args) {
        Breakfast f = new Breakfast();f.setVisible(true);
    }
    @Override
