...
public class Bkash extends  JFrame implements ActionListener, MouseListener {
    ...
    public Bkash(int tk){
        ...
        ImageIcon i = new ImageIcon("src\\Payment\\bl1.png");
        ...
        c.add(p);
        ImageIcon i2 = new ImageIcon("src\\Payment\\bkashlogo.png");
        ...
        nt.setBorder(BorderFactory.createMatteBorder(0,0,5,0,Color.WHITE));
        p.add(nt);
        /////
        JLabel pin = new JLabel("Bkash Pin :");
        ...
        pp.setBorder(BorderFactory.createMatteBorder(0,0,5,0,Color.WHITE));
        p.add(pp);
...
//////////////
    ...
    public static void main(String[] args) {
        Bkash b = new Bkash(2334);b.setVisible(true);
    }
