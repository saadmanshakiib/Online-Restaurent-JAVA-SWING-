...
public class mywallet extends  JFrame implements ActionListener, MouseListener {

    private int tk;

    public mywallet(int tk){
        this.tk = tk;
       ...
       /* ImageIcon i = new ImageIcon("src\\Payment\\t2.png");
        ...
        nt.setBorder(BorderFactory.createMatteBorder(0,0,5,0,lightblue));
        p.add(nt);
        /////
        JLabel pin = new JLabel("Tcash Pin :");
        pin.setFont(new Font("Roboto",Font.BOLD,28));
        pin.setForeground(lightblue);
        ...
        pp.setBorder(BorderFactory.createMatteBorder(0,0,5,0,lightblue));
        p.add(pp);
...
//////////////
   ...
   /* public static void main(String[] args) {
        mywallet b = new mywallet(2334);b.setVisible(true);
    }*/
    @Override
