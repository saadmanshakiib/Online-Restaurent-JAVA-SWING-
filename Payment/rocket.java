...
public class rocket extends  JFrame implements ActionListener, MouseListener {

    private int tk;

    public rocket(int tk){
        this.tk = tk;
...
Color purple = new Color(160,32,240);
        ...
        ImageIcon i = new ImageIcon("src\\Payment\\r2.png");
        JLabel img = new JLabel(i);
        img.setBounds(40,0,800,200);
        c.add(img);
        JPanel p = new JPanel();
        ...
        c.add(p);
        ImageIcon i2 = new ImageIcon("src\\Payment\\rocket.png");
        JLabel img2 = new JLabel(i2);
        img2.setBounds(100,-20,250,250);
        p.add(img2);
        JLabel n = new JLabel("Number : ");
        n.setFont(new Font("Roboto",Font.BOLD,28));
        n.setForeground(purple);
        ...
        nt.setOpaque(false);
        nt.setForeground(purple);
        nt.setBorder(BorderFactory.createMatteBorder(0,0,5,0,purple));
        p.add(nt);
        /////
        JLabel pin = new JLabel("Rocket Pin :");
        pin.setFont(new Font("Roboto",Font.BOLD,28));
        pin.setForeground(purple);
        ...
        pp.setBorder(BorderFactory.createMatteBorder(0,0,5,0,purple));
        p.add(pp);
...
//////////////
    ...
    public static void main(String[] args) {
        rocket _r = new rocket(90);_r.setVisible(true);
    }
