...
public class upay extends  JFrame implements ActionListener, MouseListener {
    ...
    public upay(int tk){
        ...
        ImageIcon i = new ImageIcon("src\\Payment\\u3.png");
        JLabel img = new JLabel(i);
        img.setBounds(40,0,800,200);
        c.add(img);
        JPanel p = new JPanel();
        p.setBounds(0,200,450,530);
        p.setLayout(null);
        p.setBackground(Color.WHITE);
        c.add(p);
        ImageIcon i2 = new ImageIcon("src\\Payment\\u2.png");
        ...
        nt.setBorder(BorderFactory.createMatteBorder(0,0,5,0,Color.YELLOW));
        p.add(nt);
        /////
        JLabel pin = new JLabel("Upay Pin :");
        ...
        pp.setBounds(180,310,220,50);
        pp.setFont(new Font("Roboto",Font.BOLD,22));
        pp.setOpaque(false);
        pp.setForeground(Color.BLACK);
        pp.setBorder(BorderFactory.createMatteBorder(0,0,5,0,Color.YELLOW));
        p.add(pp);
...
//////////////
    ...
    public static void main(String[] args) {
        upay b = new upay(2334);b.setVisible(true);
    }
